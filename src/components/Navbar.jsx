...
export default function Navbar() {
      return (
            <>
                  <nav className="z-10 flex items-center justify-around px-2 py-8 h-36 md:min-h-40 max-w-screen">
                        ...
                        <div>
                              <img src={Logo} alt="Pay4Me Logo" className="w-40 md:w-48 xl:w-80 sm:w-40 xl:-ml-24"/>
                        </div>
                        <div>
